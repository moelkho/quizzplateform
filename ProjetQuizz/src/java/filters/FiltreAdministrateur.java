 ...
 * @author admin
 */
public class FiltreAdministrateur implements Filter {
    ...
    public FiltreAdministrateur() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FiltreAdministrateur:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FiltreAdministrateur:DoAfterProcessing");
        }
 ...
 session = NewHibernateUtil.getSessionFactory().openSession();
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("FiltreAdministrateur:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FiltreAdministrateur()");
        }
        StringBuffer sb = new StringBuffer("FiltreAdministrateur(");
