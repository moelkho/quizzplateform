 ...
 * @author Youssef
 */
public class DeleteReponseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            long idASupprimer = Long.parseLong(request.getParameter("id"));
            ReponsePossibleDAO.deleteReponsePossible(idASupprimer);
